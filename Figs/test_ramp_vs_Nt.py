...
for Nt in range(100,5000,100):
    ...
    ov.append((1-abs(psi_even_Vmax.overlap(psi_even_t))**2))
    dtl.append(Nt)
...
np.savetxt("/Users/jps145/TenPy2/JohnStuff/Figs/ov_vs_Nt_L25.txt",np.array([dtl,ov]))
...
plt.savefig("/Users/jps145/TenPy2/JohnStuff/Figs/ov_vs_Nt_L25.pdf")
plt.show()
