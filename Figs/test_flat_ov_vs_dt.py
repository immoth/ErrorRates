...
for dtn in range(1,100):
    ...
    error_odd = TEBD.time_evolution(psi_odd,M0,TEBD_sim(30,t_steps,dt))
    error_even = TEBD.time_evolution(psi_even,M0,TEBD_sim(30,t_steps,dt))
...
np.savetxt("/Users/jps145/TenPy2/JohnStuff/Figs/ov_vs_dt.txt",np.array([dtl,ov]))
...
plt.savefig("/Users/jps145/TenPy2/JohnStuff/Figs/ov_vs_dt.pdf")
plt.show()
