...
for tn in range(1,100):
    ...
    TEBD_sim_0=TEBD_sim(30,t_steps,dt)
    
    error_odd = TEBD.time_evolution(psi_odd_0,M0,TEBD_sim_0)
    error_even = TEBD.time_evolution(psi_even_0,M0,TEBD_sim_0)

    print("JS|--------->TEBD has completed with time="+str(dt*t_steps))
    print(TEBD_sim_0)
...
np.savetxt("/Users/jps145/TenPy2/JohnStuff/Figs/ov_vs_time.txt",np.array([dtl,ov]))
