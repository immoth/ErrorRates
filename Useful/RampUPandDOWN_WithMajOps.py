...
print("Final Errors")
print(phase_error_x(psi_odd_t,gx0,psi_even_t))
print(phase_error_y(psi_odd_t,gy0,psi_even_t))
print(parity_error(psi_even_t,gx0,gy0,psi_even_t))
print(parity_error(psi_odd_t,gx0,gy0,psi_odd_t))
