...
for BD in range(2,50):
    ...
    print("JS|--------->Ramp Up has completed for BD = "+str(BD))
    ...
    print("JS|--------->Wait has completed for BD = "+str(BD))
    ...
    print("JS|--------->Ramp Down has completed for BD = "+str(BD))


    print("overlap after down for BD = "+str(BD))
...
np.savetxt("/Users/jps145/TenPy2/JohnStuff/Useful/Data/ph_x_Nt"+str(Nt)+"_Ntw"+str(Ntw)+"_L"+str(L)+"_Jx"+str(Jx)+"_Jy"+str(Jy)+"_hz"+str(hz[0])+"_Vmax"+str(Vmax)+"_dt"+str(dt)+"_BD"+str(BD)+".txt",ph_xl)
np.savetxt("/Users/jps145/TenPy2/JohnStuff/Useful/Data/ph_y_Nt"+str(Nt)+"_Ntw"+str(Ntw)+"_L"+str(L)+"_Jx"+str(Jx)+"_Jy"+str(Jy)+"_hz"+str(hz[0])+"_Vmax"+str(Vmax)+"_dt"+str(dt)+"_BD"+str(BD)+".txt",ph_yl)
np.savetxt("/Users/jps145/TenPy2/JohnStuff/Useful/Data/pr_e_Nt"+str(Nt)+"_Ntw"+str(Ntw)+"_L"+str(L)+"_Jx"+str(Jx)+"_Jy"+str(Jy)+"_hz"+str(hz[0])+"_Vmax"+str(Vmax)+"_dt"+str(dt)+"_BD"+str(BD)+".txt",pr_el)
np.savetxt("/Users/jps145/TenPy2/JohnStuff/Useful/Data/pr_o_Nt"+str(Nt)+"_Ntw"+str(Ntw)+"_L"+str(L)+"_Jx"+str(Jx)+"_Jy"+str(Jy)+"_hz"+str(hz[0])+"_Vmax"+str(Vmax)+"_dt"+str(dt)+"_BD"+str(BD)+".txt",pr_ol)
