...
ph_yL=np.loadtxt("/Users/jps145/TenPy2/JohnStuff/Useful/Data/Nt"+str(Nt)+"_Ntw"+str(Ntw)+"_L"+str(L)+"_Jx"+str(Jx)+"_Jy"+str(Jy)+"_hz"+str(hz[0])+"_Vmax"+str(Vmax)+"_dt"+str(dt)+"_BD"+str(BD)+"_Nz"+"_ph_y.txt",dtype='cdouble')
pr_eL=np.loadtxt("/Users/jps145/TenPy2/JohnStuff/Useful/Data/Nt"+str(Nt)+"_Ntw"+str(Ntw)+"_L"+str(L)+"_Jx"+str(Jx)+"_Jy"+str(Jy)+"_hz"+str(hz[0])+"_Vmax"+str(Vmax)+"_dt"+str(dt)+"_BD"+str(BD)+"_Nz"+"_pr_e.txt",dtype='cdouble')
pr_oL=np.loadtxt("/Users/jps145/TenPy2/JohnStuff/Useful/Data/Nt"+str(Nt)+"_Ntw"+str(Ntw)+"_L"+str(L)+"_Jx"+str(Jx)+"_Jy"+str(Jy)+"_hz"+str(hz[0])+"_Vmax"+str(Vmax)+"_dt"+str(dt)+"_BD"+str(BD)+"_Nz"+"_pr_o.txt",dtype='cdouble')
